...
if __name__ in '__main__':
    ...
    a = input('a = ')
    if a == '1':
        #path_4 = s3.union(shape_list, name_list_shape, 'union_file_12_05_2021.csv')
        path_4 = 'union_file_12_05_2021.csv'
    print('7')
    s4.transformation_pay(path_4, 'full_union_file_12_05_2021.csv', 2021)
