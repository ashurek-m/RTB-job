...
save_csv_header_w('full_pay_2019-2021.csv', w_or_a='a', data_frame=df_2020, columns=False)
save_csv_header_w('full_pay_2019-2021.csv', w_or_a='a', data_frame=df_2021, columns=False)
print('next')
input()
df = pd.read_csv('full_pay_2019-2021.csv', low_memory=False)
